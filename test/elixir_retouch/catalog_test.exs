defmodule ElixirRetouch.CatalogTest do
  use ElixirRetouch.DataCase

  alias ElixirRetouch.Catalog

  describe "products" do
    alias ElixirRetouch.Catalog.Product

    import ElixirRetouch.CatalogFixtures
  ...
  describe "categories" do
    alias ElixirRetouch.Catalog.Category
